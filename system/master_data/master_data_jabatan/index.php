...
<html>
<head>
  <title> Master Data Jabatan <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataJabatan('namaJabatan')">
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Jabatan</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahJabatan" type="button" class="btn btn-info" onclick="tambahJabatan()" style="height: 40px;">
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataJabatan('namaJabatan')">
                          Jabatan 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataJabatan"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataJabatan" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <h4 class="modal-title">
            <i class="fa fa-user"></i> Master Data Jabatan
          </h4>
        </div>
        <div class="modal-body" id="dataFormMasterDataJabatan"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatajabatan.js"></script>
</body>
</html> 