...
<html>
<head>
  <title> Master Data Bank <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataBank('noRekening')">
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Bank</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahBank" type="button" class="btn btn-info" onclick="tambahBank()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Bank Baru
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataBank('noRekening')">
                          No Rekening 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataBank('namaBank')">
                          Nama Bank 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataBank('atasNama')">
                          Atas Nama Rekening 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataBank('tipe')">
                          Tipe 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataBank"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataBank" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <h4 class="modal-title">
            <i class="fa fa-user"></i> Master Data Bank
          </h4>
        </div>
        <div class="modal-body" id="dataFormMasterDataBank"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatabank.js"></script>
</body>
</html>