...
<html>
<head>
  <title> Master Data Jenis Penjualan <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataJenisPenjualan()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data Jenis Penjualan</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Jenis Penjualan</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahJenisPenjualan" type="button" class="btn btn-info" onclick="tambahJenisPenjualan()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Jenis Penjualan Baru
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataJenisPenjualan('jenisPenjualan')">
                          Jenis Penjualan 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataJenisPenjualan"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataJenisPenjualan" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <h4 class="modal-title">
            <i class="fa fa-user"></i> Master Data Jenis Penjualan
          </h4>
        </div>
        <div class="modal-body" id="dataFormMasterDataJenisPenjualan"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatajenispenjualan.js"></script>
</body>
</html>