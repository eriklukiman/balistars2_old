...
<html>
<head>
  <title> Master Data Supplier <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataSupplier()">
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Supplier</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahSupplier" type="button" class="btn btn-info" onclick="tambahSupplier()" style="height: 40px;">
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataSupplier('namaSupplier')">
                          Nama Suplier
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataSupplier('alamatSupplier')">
                          Alamat Supplier
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataSupplier('noTelpSupplier')">
                          Nomor Telepon
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataSupplier('tipeSupplier')">
                          Tipe
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataSupplier"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataSupplier" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <h4 class="modal-title">
            <i class="fa fa-user"></i> Master Data Supplier
          </h4>
        </div>
        <div class="modal-body" id="dataFormMasterDataSupplier"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatasupplier.js"></script>
</body>
</html>