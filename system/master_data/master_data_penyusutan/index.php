...
<html>
<head>
  <title> Master Data Penyusutan <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataPenyusutan()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data Penyusutan</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Penyusutan</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahPenyusutan" type="button" class="btn btn-info" onclick="tambahPenyusutan()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Penyusutan Baru
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="form-group col-sm-3" >
                  <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarMasterDataPenyusutan()">
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPenyusutan('tanggalPenyusutan')">
                          Tanggal Penyusutan 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPenyusutan('idCabang)">
                          Cabang
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPenyusutan('nilaiPenyusutan')">
                          Penyusutan 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPenyusutan('nilaiSetorHO')">
                          Setor HO 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataPenyusutan"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataPenyusutan" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Master Data Penyusutan
            </h4>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormMasterDataPenyusutan"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatapenyusutan.js"></script>
</body>
</html>