...
<html>
<head>
  <title> Master Data Jenis Biaya Cabang <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataJenisBiayaCabang('jenisBiayaCabang')">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data Jenis Biaya Cabang</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Jenis Biaya Cabang</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahJenisBiayaCabang" type="button" class="btn btn-info" onclick="tambahJenisBiayaCabang()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Jenis Biaya Cabang
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataJenisBiayaCabang('jenisBiayaCabang')">
                          Jenis Biaya Cabang 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataJenisBiayaCabang"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataJenisBiayaCabang" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Master Data Jenis Biaya Cabang
            </h4>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormMasterDataJenisBiayaCabang"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatajenisbiayacabang.js"></script>
</body>
</html> 