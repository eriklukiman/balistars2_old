...
<html>
<head>
  <title> Master Data Target <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataTarget('noRekening')">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data Target</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Target</h5>
                  </div>
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3">
                    <select class="form-control select2" id="idJenisPenjualan" onchange="dataDaftarMasterDataTarget()">
                      ...
                      foreach ($dataJenisPenjualan as $data) {
                        ?>
                        <option value="<?=$data['idJenisPenjualan']?>"><?=$data['jenisPenjualan']?></option>
                        <?php
                      }
                      ?>
                    </select>
                  ...
                  <div class="col-sm-3" >
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarMasterDataTarget()">
                  </div>
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataTarget()">
                          Cabang 
                        </button>
                      </th>
                      <th>
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataTarget(target)">
                          Target 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataTarget"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataTarget" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Master Data Target
            </h4>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormMasterDataTarget"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatatarget.js"></script>
</body>
</html>