...
<head>
    <title> Master Data Penyesuaian <?= $dataInformasi['nama'] ?></title>
    <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataPenyesuaian()">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Master Data Penyesuaian</li>
                            </ul>
                        </div>
                    ...
                    <div class="col-sm-12">
                        <div class="card planned_task">
                            ...
                            <div class="header">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h5><i class="fas fa-stream pr-4"></i> <strong>DAFTAR PENYESUAIAN</strong></h5>
                                    </div>
                                    <div class="col-sm-6 text-right">
                                        <button id="tombolTambahPenyesuaian" type="button" class="btn btn-info" onclick="getFormPenyesuaian()" style="height: 40px;">
                                            <i class="fas fa-plus-circle pr-2"></i> <strong>PENYESUAIAN BARU</strong>
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="body">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-3">
                                        <label>RENTANG</label>
                                        <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarMasterDataPenyesuaian()">
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-hover table-custom">
                                        <thead class="bg-info text-white">
                                            ...
                                            <th class="text-center">
                                                <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPenyesuaian('jenisPenyesuaian')">
                                                    <strong>JENIS PENYESUAIAN</strong>
                                                </button>
                                            </th>
                                            <th class="text-center">
                                                <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPenyesuaian('tipePembayaran')">
                                                    <strong>TIPE BAYAR</strong>
                                                </button>
                                            </th>
                                            <th class="text-center">
                                                <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPenyesuaian('cabang')">
                                                    <strong>CABANG</strong>
                                                </button>
                                            </th>
                                            <th class="text-center">
                                                <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPenyesuaian('tanggalPenyesuaian')">
                                                    <strong>PERIODE</strong>
                                                </button>
                                            </th>
                                            <th class="text-center">
                                                <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPenyesuaian('status')">
                                            ...
                                            <th class="text-center">
                                                <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPenyesuaian('keterangan')">
                                                    <strong>KETERANGAN</strong>
                                                </button>
                                            </th>
                                        </thead>
                                        <tbody id="dataDaftarMasterDataPenyesuaian"></tbody>
                                    </table>
                                </div>
                            </div>
                            <!-- End Body -->
    ...
    <div id="modalFormMasterDataPenyesuaian" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header alert alert-primary">
                    <div class="col-sm-11">
                        <h4 class="modal-title">
                            <i class="fa fa-user pr-3"></i> <strong>MASTER DATA PENYESUIAN</strong>
                        </h4>
                    </div>
                ...
                <div class="modal-body" id="dataFormMasterDataPenyesuaian"></div>
            </div>
        </div>
    </div>
    ...
    <script src="js/masterdatapenyesuaian.js"></script>
