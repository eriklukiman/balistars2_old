...
<html>
<head>
  <title> Master Data Cabang Advertising <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataCabangAdvertising()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data Cabang Advertising</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Cabang Advertising</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahCabangAdvertising" type="button" class="btn btn-info" onclick="tambahCabangAdvertising()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Cabang Advertising Baru
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCabangAdvertising('namaCabang')">
                          nama Cabang 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCabangAdvertising('alamatCabang')">
                          Alamat Cabang 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCabangAdvertising('kota')">
                          Kota Cabang 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCabangAdvertising('noTelpCabang')">
                          Nomor Telepon 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataCabangAdvertising"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataCabangAdvertising" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <h4 class="modal-title">
            <i class="fa fa-user"></i> Master Data Cabang Advertising
          </h4>
        </div>
        <div class="modal-body" id="dataFormMasterDataCabangAdvertising"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatacabangadvertising.js"></script>
</body>
</html>