...
<html>
<head>
  <title> Absensi Pulang <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarAbsensiPulang()">
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Absensi Pulang</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahAbsensiPulang" type="button" class="btn btn-info" onclick="tambahAbsensiPulang()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Absensi Pulang Baru
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="row">
                  <div class="form-group col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang"  onchange="dataDaftarAbsensiPulang()">
                  </div>
                  <div class="form-group col-sm-3" >
                    <label>Cabang</label>
                    <select name="idCabang" id="idCabang" class="form-control select2" onchange="dataDaftarAbsensiPulang()">
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarAbsensiPulang('')">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarAbsensiPulang('')">
                          Jam Pulang <i class="fa fa-sort-alpha-up"></i>
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarAbsensiPulang"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormAbsensiPulang" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 80%">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Absensi Pulang
            </h4>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormAbsensiPulang"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/absensipulang.js"></script>
