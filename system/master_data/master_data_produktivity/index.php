...
<html>
<head>
  <title> Master Data Produktivity <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataProduktivity()">
  <div id="wrapper">
    <?php
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data Produktivity</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Produktivity</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahProduktivity" type="button" class="btn btn-info" onclick="tambahProduktivity()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Produktivity Baru
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="form-group col-sm-3" >
                  <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarMasterDataProduktivity()">
                </div>
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataProduktivity('idCabang')">
                          Cabang 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataProduktivity('tanggalProduktivity')">
                          Tanggal Produktivity 
                        </button>
                      </th>
                      <th style="text-align: center;">
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataProduktivity('hariLibur')">
                          Hari Libur 
                        </button>
                      </th>
                      <th style="text-align: center;">
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataProduktivity('nominalProduktif')">
                         Nominal Produktivity 
                        </button>
                      </th>
                      <th style="text-align: center;">
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataProduktivity('jumlahPegawai')">
                          Jumlah Pegawai 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataProduktivity"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataProduktivity" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Master Data Produktivity
            </h4>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormMasterDataProduktivity"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdataproduktivity.js"></script>  
</body>
</html>