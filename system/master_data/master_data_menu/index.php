...
<head>
  <title> Master Data Menu <?= $dataInformasi['nama'] ?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataMenu()">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data Menu</li>
              </ul>
            </div>
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Menu</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahMenu" type="button" class="btn btn-info" onclick="tambahMenu()" style="height: 40px;">
                      <i class="fa fa-plus-circle pr-2"></i> Menu Baru
                    </button>
                  </div>
                </div>
              </div>
                  ...
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th style="text-align: center;">
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataMenu('namaMenu')">
                          Nama Menu
                        </button>
                      </th>
                      <th style="text-align: center;">
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataMenu('icon')">
                          icon
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataMenu"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataMenu" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user pr-4"></i> <strong>MASTER DATA MENU</strong>
            </h4>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormMasterDataMenu"></div>
      </div>
    </div>
  </div>

  <div id="modalFormMasterDataMenuSub" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fas fa-stream pr-4"></i> <strong>MASTER DATA MENU SUB</strong>
            </h4>
          </div>
          <div class="col-sm-1">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">X</button>
        ...
        <div class="modal-body" id="dataFormMasterDataMenuSub"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatamenu1.js"></script>
</body>
