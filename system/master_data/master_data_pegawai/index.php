...
<html>
<head>
  <title> Master Data Pegawai <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataPegawai('namaPegawai')">
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Pegawai</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahPegawai" type="button" class="btn btn-info" onclick="tambahPegawai()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Pegawai Baru
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>  
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPegawai('NIKPegawai')">
                          NIK 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPegawai('namaPegawai')">
                          Nama Pegawai 
                        </button>
                      </th>

                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPegawai('tglMulaiKerja')">
                          Tanggal Mulai Kerja 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPegawai('alamatPegawai')">
                          Alamat Pegawai 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPegawai('noTelpPegawai')">
                          No Telp Pegawai 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPegawai('jabatan')">
                          Jabatan 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataPegawai('namaCabang')">
                          Unit Kerja 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataPegawai"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataPegawai" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Master Data Pegawai
            </h4>
          </div>
          <div>
        ...
        <div class="modal-body" id="dataFormMasterDataPegawai"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatapegawai.js"></script>
</body>
</html>