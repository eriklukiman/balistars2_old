...
<html>
<head>
  <title> Master Data Customer <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataCustomer()">
              ...
              <div class="header">
                <div class="row">
                  ...
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahCustomer" type="button" class="btn btn-info" onclick="tambahCustomer()" style="height: 40px;">
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCustomer('namaCustomer')">
                          Nama Customer 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCustomer('NPWP')">
                          NPWP 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCustomer('alamatCustomer')">
                          Alamat Customer 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCustomer('noTelpCustomer')">
                          Nomor Telepon 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataCustomer"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataCustomer" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Master Data Customer
            </h4>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormMasterDataCustomer"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatacustomer.js"></script>
</body>
</html>