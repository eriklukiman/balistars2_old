...
<html>
<head>
  <title> Master Data Cabang <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataCabang()">
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Cabang</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahCabang" type="button" class="btn btn-info" onclick="tambahCabang()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Cabang Baru
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCabang('namaCabang')">
                          Nama Cabang 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCabang('alamatCabang')">
                          Alamat Cabang 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCabang('kota')">
                          Kota 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCabang('area')">
                          Area 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataCabang()">
                          Nomor Telepon 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataCabang"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataCabang" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Master Data Cabang
            </h4>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormMasterDataCabang"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatacabang.js"></script>
</body>
</html>