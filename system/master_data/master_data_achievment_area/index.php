...
<html>
<head>
  <title> Master Data Achievement <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataAchievement()">
  <div id="wrapper">
    <?php
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data Achievement</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Achievement</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahAchievement" type="button" class="btn btn-info" onclick="tambahAchievement()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Achievement Baru
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="form-group" >
                  <input type="datepicker" class="form-control" name="rentang" id="rentang" style="width : 25%" onchange="getDaftarRentang()">
                </div>
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataAchievement('area')">
                          Area 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataAchievement('tanggalAchievement')">
                          Tanggal Achievement 
                        </button>
                      </th>
                      <th style="text-align: center;">
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataAchievement('jumlahAchievement')">
                          Achievement Bulanan 
                        </button>
                      </th>
                      <th style="text-align: center;">
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataAchievement('AchievementHariEfektif')">
                         Achievement Hari Efektif 
                        </button>
                      </th>
                      <th style="text-align: center;">
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataAchievement('AchievementHariWeekend')">
                          Achievement Sabtu Munggu 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataAchievement"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataAchievement" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 75%">
      <div class="modal-content">
        ...
        <div class="modal-body" id="dataFormMasterDataAchievement"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdataachievementarea.js"></script>  
