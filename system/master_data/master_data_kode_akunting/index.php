...
<html>
<head>
  <title> Master Data Kode Akunting <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataKodeAkunting('kodeAkunting')">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data Kode Akunting</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Kode Akunting</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahKode Akunting" type="button" class="btn btn-info" onclick="tambahKodeAkunting()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Kode Akunting Baru
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataKodeAkunting('kodeAkunting')">
                          Kode Akunting 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataKodeAkunting('keterangan')">
                          keterangan 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataKodeAkunting"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataKodeAkunting" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <h4 class="modal-title">
            <i class="fa fa-user"></i> Master Data Kode Akunting
          </h4>
        </div>
        <div class="modal-body" id="dataFormMasterDataKodeAkunting"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatakodeakunting.js"></script>
</body>
</html>