...
<html>
<head>
  <title> Master Data Kode Neraca <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataKodeNeraca('kodeNeracaLajur')">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data Kode Neraca</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Kode Neraca</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahKode Neraca" type="button" class="btn btn-info" onclick="tambahKodeNeraca()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Kode Neraca Baru
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataKodeNeraca('kodeNeraca')">
                          Kode Neraca 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataKodeNeraca('keterangan')">
                          keterangan 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataKodeNeraca"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataKodeNeraca" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Master Data Kode Neraca
            </h4>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormMasterDataKodeNeraca"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatakodeneraca.js"></script>
</body>
</html>