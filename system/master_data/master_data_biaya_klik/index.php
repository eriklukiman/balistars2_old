...
<html>
<head>
  <title> Master Data Biaya Klik <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataBiayaKlik()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data Biaya Klik</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Biaya Klik</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahBiayaKlik" type="button" class="btn btn-info" onclick="tambahBiayaKlik()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Biaya Klik Baru
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataBiayaKlik('idCabang')">
                          Cabang 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataBiayaKlik('tanggalBiaya')">
                          Tanggal 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataBiayaKlik('jumlahBiaya')">
                          Jumlah Biaya 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataBiayaKlik"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataBiayaKlik" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width : 75%">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Master Data Biaya Klik
            </h4>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormMasterDataBiayaKlik"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatabiayaklik.js"></script>
</body>
</html>