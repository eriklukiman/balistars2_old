...
<html>
<head>
  <title> Master Data Gedung <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMasterDataGedung()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data Gedung</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Gedung</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahGedung" type="button" class="btn btn-info" onclick="tambahGedung()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Gedung Baru
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataGedung('namaGedung')">
                          Nama Gedung 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataGedung('idCabang')">
                          Cabang 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataGedung('keterangan')">
                          Keterangan 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataGedung"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataGedung" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Master Data Gedung
            </h4>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormMasterDataGedung"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatagedung.js"></script>
</body>
</html>