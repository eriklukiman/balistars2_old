...
<head>
  <title> Master Data User Account <?= $dataInformasi['nama'] ?></title>
  <meta charset="utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=edge, chrome=1">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
  <meta name="description" content="Kenak Medika">
...
<body class="theme-blue" onload="dataDaftarMasterDataUser('namaPegawai')">
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Master Data User Account</li>
              </ul>
            </div>
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar User</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahUser" type="button" class="btn btn-info" onclick="tambahUser()" style="height: 40px;">
                      <i class="fa fa-plus-circle pr-2"></i> User Baru
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataUser('namaPegawai')">
                          Nama Pegawai 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataUser('tipeUser')">
                          Tipe User 
                        </button>
                      </th>
                      <th>
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMasterDataUser('userName')">
                          User Name 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMasterDataUser"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMasterDataUser" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Master Data User Account
            </h4>
          </div>
          <div>
        ...
        <div class="modal-body" id="dataFormMasterDataUser"></div>
      </div>
    </div>
  </div>

  <div id="modalFormMenuUser" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-info">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Menu User
            </h4>
          </div>
          <div class="col-sm-1">
            <button type="button" class="btn btn-secondary" data-dismiss="modal">X</button>
        ...
        <div class="modal-body" id="dataFormMenuUser"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/masterdatauser.js"></script>
</body>
