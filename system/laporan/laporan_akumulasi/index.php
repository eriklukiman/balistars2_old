...
<html>
<head>
  <title>Laporan Akumulasi <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarAkumulasi()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Akumulasi</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Laporan Akumulasi</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    ...
                    <div class="input-group date"  data-date-autoclose="true" data-provide="datepicker"  data-date-format="dd-mm-yyyy">
                      <input type="tanggal" class="form-control" name="tanggal" id="tanggal" value="<?=date('d-m-Y')?>" onchange="dataDaftarAkumulasi()" autocomplete="off">
                  ...
                  <div class="col-sm-2" <?=$style?>>
                    <label>Tipe</label>
                    <select name="tipe" id="tipeSearch" class="form-control select2"  onchange="dataDaftarAkumulasi()" >
                      <?php
                ...
                <div style="overflow-x: auto;">
                  <div id="dataDaftarAkumulasi"></div>
                </div>
              </div>
              <!-- End Body -->
            </div>
  ...
  <script src="js/akumulasi.js"></script>
