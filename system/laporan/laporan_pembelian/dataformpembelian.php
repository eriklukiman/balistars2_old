...
if($dataUpdate){
  ...
  $tipe=$dataUpdate['tipePembelian'];
  $idCabang=$dataUpdate['idCabang'];
  if($dataUpdate['idSupplier']!=0){
    $konsumen = 'Giro';
  } else{
    $konsumen = 'Cash';
  }
...
<form id="formPembelian">
  ...
  <div class="row">
    <div class="form-group col-sm-6">
      <label>No Nota/Suplier <?=$tipe?></label>
      ...
      <div class="form-inline">
        ...
        if($tipe=='A1'){
        ?>
          <select name="jenisPPN" class="form-control select2" id="jenisPPN" onchange="getPembelianTersimpan(); showPersenPPN()" style="width: 25%;" required>
            <?php
          ...
          <select name="persenPPN" class="form-control select2" onchange="getPembelianTersimpan();" id="persenPPN" style="width: 95%;" required>
              <?php
      ...
      <?php 
      if($tipe=='A1' && $dataLogin['idCabang']==9){
        ?>
        <label>Faktur Pajak</label>
        <div class="form-inline">
          <input type="text" class="form-control" id="noFakturPajak" name="noFakturPajak" value="<?=$dataUpdate['noFakturPajak']??''?>" style="width: 45%;" placeholder="input Faktur Pajak">
        </div>
        <?php
      } else{
        ?>
        <input type="hidden" name="noFakturPajak" id="noFakturPajak" value="Null">
        <?php
      } ?>
    </div>
    <div class="form-group col-sm-6">
