...
<form id="formBiaya">
  ...
  <input type="hidden" name="idCabang" id="idCabang" value="<?=$dataUpdate['idCabang']?>">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-sm-3">
       <label>Cabang</label>
      <input type="text" class="form-control" id="cabang" value="<?=$dataUpdate['namaCabang']??''?>" readonly>       
    </div>
    <div class="form-group col-sm-3">
      <?php 
      $disabled='disabled';
      if($dataLogin['idCabang']==9){
        $disabled='';
      } 
      ?>
  ...
  <div class="form-row">
    ...
    if($tipe=='A1'){
      ...
      <div class="form-group col-sm-3">
        ...
        <select name="jenisPPN" class="form-control select2" id="jenisPPN" onchange="getBiayaTersimpan(); showPersen();" style="width: 100%;" required>
          <?php
      ...
      <?php 
      $style2='';
      if($dataUpdate['jenisPPN']=='Non PPN'){
        $style2 = 'style="display: none;"';
      }?>
      <div class="form-group col-sm-3" id="boxPersenPPN" <?=$style2?> >
      <label>Persen PPN</label>
      <select name="persenPPN" class="form-control select2" onchange="getBiayaTersimpan();" id="persenPPN" style="width: 100%;" required>
          <?php
