...
<?php
  ...
  tampilTable(intval($total['debet'])-intval($total['kredit']),'<b>Grand Total<b>',$total['saldoAwal'],$total['debet'],$total['kredit'],$total['saldoAkhir'],$total['memorial'],$total['laba'],$total['neraca'],$total)
