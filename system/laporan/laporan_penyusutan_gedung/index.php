...
<html>
<head>
  <title>Penyusutan Gedung <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPenyusutanGedung()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Penyusutan Gedung</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Laporan Penyusutan Gedung</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-2">
                    <label>Tahun</label>
                    <select class="form-control select2" name="tahun1" id="tahun1" onchange="dataDaftarPenyusutanGedung();">
                      <?php
                      pilihTahun($tahun1);
                      ?>
                    </select>
                  ...
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      <tr>
                        ...
                        <th>
                          <button class="btn btn-sm btn-info" onclick="dataDaftarPenyusutanGedung()">
                            Gedung
                          </button>
                        </th>
                        <th>
                          <button class="btn btn-sm btn-info" onclick="dataDaftarPenyusutanGedung('noNota')">
                            Awal
                          </button>
                        </th>
                        <th>
                    ...
                    <tbody id="dataDaftarPenyusutanGedung"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <script src="js/penyusutangedung.js"></script>
