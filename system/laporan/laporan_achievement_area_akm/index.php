...
<html>
<head>
  <title>Achievement Area Akm <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarAchievementAreaAkm()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Achievement Area Akumulasi</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Laporan Achievement Area Akumulasi</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  ...
                  <div class="col-sm-3">
                    <label>Area</label>
                    <select class="form-control select2" name="area" id="area" onchange="dataDaftarAchievementAreaAkm()">
                      <option>Pilih Area</option>
                      <?php 
                      $arrayArea = array('timur','barat','utara','selatan');
                      for($i=0; $i<count($arrayArea); $i++){
                       ?>
                       <option value="<?=$arrayArea[$i]?>"><?=$arrayArea[$i]?></option>
                       <?php
                      }
                      ?>
                    </select>
                  ...
                  elseif($dataLogin['tipeUser']=='Kontrol Area'){
                    ?>
                    <input type="hidden" name="area" id="area" value="<?=$dataLogin['area']?>">
                    <?php
                  } ?>
                  <div class="col-sm-2">
                    <label>Bulan</label>
                    <select class="form-control select2" name="bulan1" id="bulan1" onchange="dataDaftarAchievementAreaAkm();">
                      <?php
                      pilihBulan($bulan1);
                      ?>
                    </select>
                  ...
                  <div class="col-sm-2">
                    <label>Tahun</label>
                    <select class="form-control select2" name="tahun1" id="tahun1" onchange="dataDaftarAchievementAreaAkm();">
                      <?php
                      pilihTahun($tahun1);
                      ?>
                    </select>
                ...
                <div style="overflow-x: auto;">
                  <div id="dataDaftarAchievementAreaAkm"></div>
                </div>
              </div>
              <!-- End Body -->
            </div>
  ...
  <script src="js/achievementareaakm.js"></script>
