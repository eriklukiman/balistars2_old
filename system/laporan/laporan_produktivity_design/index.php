...
<html>
<head>
  <title>Laporan Produktivity Design <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarProduktivityDesign()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Produktivity Design</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Produktivity Design</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarProduktivityDesign()">
                  </div>
                  <?php 
                  ...
                  <div class="col-sm-3" >
                    <label>Cabang</label>
                    <select name="idCabang" id="idCabangSearch" class="form-control select2" style="width: 100%;" onchange="dataDaftarProduktivityDesign()">
                      <?php
                  ...
                  <?php 
                  }elseif($dataLogin['tipeUser']=='Kepala Cabang'){
                    ?>
                  <div class="col-sm-3" >
                    <label>Cabang</label>
                    <select name="idCabang" id="idCabangSearch" class="form-control select2" style="width: 100%;" onchange="dataDaftarProduktivityDesign()">
                      <?php
                      $sqlCabang=$db->prepare('SELECT * FROM balistars_cabang where statusCabang=? and idCabang=? order by namaCabang');
                      $sqlCabang->execute(['Aktif',$dataLogin['idCabang']]);
                      $dataCabang = $sqlCabang->fetchAll();
                      foreach($dataCabang as $data){
                        ?>
                        <option value="<?=$data['idCabang']?>"><?=$data['namaCabang']?></option>
                  ...
                  <div class="col-sm-2" <?=$style?>>
                    <label>Tipe</label>
                    <select name="tipe" id="tipeSearch" class="form-control select2"  onchange="dataDaftarProduktivityDesign()" >
                      <?php
                      $arrayTipe=array('Order','Rupiah');
                      $arrayTipeVal=array('jumlahOrder','jumlahRupiah');
                      for($i=0; $i<count($arrayTipe); $i++){
                        ?>
                        <option value="<?=$arrayTipeVal[$i]?>" > <?=$arrayTipe[$i]?> </option>
                        <?php
                      }
                      ?>
                    </select>
                  ...
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      <tr>
                        ...
                        <th>
                          <button class="btn btn-sm btn-info" onclick="dataDaftarProduktivityDesign()">
                            Nama Designer
                          </button>
                        </th>
                        <th>
                    ...
                    <tbody id="dataDaftarProduktivityDesign"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormProduktivityDesign" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 80%">
      <div class="modal-content">
        ...
        <div class="modal-body" id="dataFormProduktivityDesign"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/produktivitydesign.js"></script>
