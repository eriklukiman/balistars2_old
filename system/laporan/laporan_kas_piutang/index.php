...
<html>
<head>
  <title>Kas Piutang <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarKasPiutang()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Kas Piutang</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Kas Piutang</h5>
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarKasPiutang()">
                  </div>
                  <?php 
                  ...
                  <div class="col-sm-3" >
                    <label>Cabang</label>
                    <select name="idCabang" id="idCabangSearch" class="form-control select2" style="width: 100%;" onchange="dataDaftarKasPiutang()">
                      <?php
                  ...
                  <!--  <div class="col-sm-2">
                    ...
                    <select name="jenisPembayaran" id="jenisPembayaranSearch" class="form-control select2"  onchange="dataDaftarKasPiutang()" >
                      <?php
                      $arrayJenisPembayaran=array('Transfer','Cash','PPN','Semua');
                      $arrayJenisPembayaranVal=array('Transfer','0','-','Semua');
                  ...
                  <div class="col-sm-2" <?=$style?>>
                    <label>Tipe</label>
                    <select name="tipe" id="tipeSearch" class="form-control select2"  onchange="dataDaftarKasPiutang()" >
                      <?php
                ...
                <div style="overflow-x: auto;">
                  ...
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarKasPiutang()">
                          Tanggal
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarKasPiutang"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <script src="js/kaspiutang.js"></script>
