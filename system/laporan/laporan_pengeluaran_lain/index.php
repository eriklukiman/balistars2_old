...
<body class="theme-blue" onload="dataDaftarPengeluaranLain()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Pengeluaran Lain</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Pengeluaran Lain</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control form-control-lg" name="rentang" id="rentang" onchange="dataDaftarPengeluaranLain()">
                  </div>
                  <div class="col-sm-6">
                    <label>Kode Akunting</label>
                    <select name="kodeAkunting" id="kodeAkuntingSearch" class="form-control select2" onchange="dataDaftarPengeluaranLain()"  required>
                        ...
                        foreach($dataKode as $row){
                          ?>
                          <option value="<?=$row['kodeAkunting']?>"> <?=$row['kodeAkunting']?> (<?=$row['keterangan']?>) </option>
                          <?php
                        }
                        ?>
                      </select>
  ...
  <script src="js/pengeluaranlain.js"></script>
