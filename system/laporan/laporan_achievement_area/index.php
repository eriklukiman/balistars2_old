...
<html>
<head>
  <title>Achievement Area <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarAchievementArea()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Achievement Area</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Laporan Achievement Area</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  ...
                  <div class="col-sm-3">
                    <label>Area</label>
                    <select class="form-control select2" name="area" id="area" onchange="dataDaftarAchievementArea()">
                  ...
                  <div class="col-sm-2">
                    <label>Bulan</label>
                    <select class="form-control select2" name="bulan1" id="bulan1" onchange="dataDaftarAchievementArea();">
                      <?php
                      pilihBulan($bulan1);
                      ?>
                    </select>
                  ...
                  <div class="col-sm-2">
                    <label>Tahun</label>
                    <select class="form-control select2" name="tahun1" id="tahun1" onchange="dataDaftarAchievementArea();">
                      <?php
                      pilihTahun($tahun1);
                      ?>
                    </select>
                ...
                <div style="overflow-x: auto;">
                  <div id="dataDaftarAchievementArea"></div>
                </div>
              </div>
              <!-- End Body -->
            </div>
  ...
  <script src="js/achievementarea.js"></script>
