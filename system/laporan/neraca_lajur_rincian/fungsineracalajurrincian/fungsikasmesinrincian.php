<?php  
function kasMesin($db,$kodeACC,$tanggalAwal,$tanggalAkhir,$total)
{
...
$execute = array(
	...
	"
	    ...
	    UNION ALL
	    (
	    	SELECT keterangan as keterangan, dpp as kredit, 0 as debet, tanggalPenjualan as tanggal, timeStamp 
