<?php  
function kasBiayaAdmin($db,$kodeACC,$tanggalAwal,$tanggalAkhir,$total)
{
	...
	"
	    ...
	    UNION ALL
	    (
		    SELECT balistars_piutang.noNota as keterangan, biayaAdmin as debet, 0 as kredit, tanggalPembayaran as tanggal, balistars_piutang.timeStamp as timeStamp 
