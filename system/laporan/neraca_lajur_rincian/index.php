...
<html>
<head>
  <title>Neraca Lajur Rincian <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarNeracaLajurRincian()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Neraca Lajur Rincian</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Neraca Lajur Rincian</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-4" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control form-control-lg" name="rentang" id="rentang" onchange="dataDaftarNeracaLajurRincian()">
                  </div>
                  <div class="col-sm-5">
                    <?php selectRincian() ?>
                  </div>
                ...
                <div style="overflow-x: auto;">
                  ...
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarNeracaLajurRincian()">
                          Tanggal Transaksi
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarNeracaLajurRincian"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <script src="js/neracalajurrincian.js"></script>
