...
<html>
<head>
  <title>PPH, PPN dan Biaya Admin <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPphPpn()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan PPH, PPN dan Biaya Admin</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar PPH, PPN dan Biaya Admin</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control form-control-lg" name="rentang" id="rentang" onchange="dataDaftarPphPpn()">
                  </div>
                  <?php 
                  ...
                  <div class="col-sm-3" >
                    <label>Cabang</label>
                    <select name="idCabang" id="idCabangSearch" class="form-control select2" style="width: 100%;" onchange="dataDaftarPphPpn()">
                      <?php
                  ...
                  <div class="col-sm-3">
                    ...
                    <select class="form-control select2" name="jenisBiaya" id="jenisBiaya" onchange="dataDaftarPphPpn()">
                      <?php 
                      $arrayJenisBiaya = array('PPH','PPN','Biaya Admin');
                      for($i=0; $i<count($arrayJenisBiaya); $i++){
                       ?>
                       <option value="<?=$arrayJenisBiaya[$i]?>"><?=$arrayJenisBiaya[$i]?></option>
                       <?php
                      }
                      ?>
                    </select>
              ...
              <div style="overflow-x: auto;">
                <table class="table table-bordered table-custom">
                  <thead class="bg-info text-white">
                    ...
                    <th>
                      <button class="btn btn-sm btn-info" onclick="dataDaftarPphPpn()">
                        Tanggal Nota
                      </button>
                    </th>
                    <th>
                  ...
                  <tbody id="dataDaftarPphPpn"></tbody>
                </table>
              </div>
            </div>
            <!-- End Body -->
  ...
  <script src="js/pphppn.js"></script>
