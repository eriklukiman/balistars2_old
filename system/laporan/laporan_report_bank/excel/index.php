...
<html>
<head>
	<title>Export Laporan Kas Bank</title>
<?php
...
$filename = 'Laporan Kas Bank '.$namaCabang.' '.ubahTanggalIndo($tanggalAwal).'-'.ubahTanggalIndo($tanggalAkhir);
...
<body>
 <table border="1">
  <tr>
    <th colspan="5" style="font-size: 17px; text-align: center;">Laporan Kas Bank <?=$dataBank['namaBank']?> <br> <?=ubahTanggalIndo($tanggalAwal)?> - <?=ubahTanggalIndo($tanggalAkhir)?></th>
  </tr>
  <tr>
    <th>Tanggal </th>
    <th>Keterangan </th>
