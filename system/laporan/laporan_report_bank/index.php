...
<html>
<head>
  <title>Report Bank <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarReportBank()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Report Bank</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Report Bank</h5>
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarReportBank()">
                  </div>
                  <div class="col-sm-3" >
                    <label>Bank</label>
                    <select name="idBank" id="idBankSearch" class="form-control select2" style="width: 100%;" onchange="dataDaftarReportBank()">
                      <?php
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarReportBank()">
                          Tanggal
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarReportBank"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <script src="js/reportbank.js"></script>
