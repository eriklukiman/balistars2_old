...
<html>
<head>
  <title>Point SDM <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPointSDM()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Point SDM</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Laporan Point SDM</h5>
                  </div>
                  <div class="col-sm-6">
                    <button type    = "button"
                            title   = "Print" 
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  ...
                  <div class="col-sm-3" >
                    <label>Cabang</label>
                    <select name="idCabang" id="idCabangSearch" class="form-control select2" style="width: 100%;" onchange="dataDaftarPointSDM()">
                      <?php
                  ...
                  <div class="col-sm-2">
                    <label>Bulan</label>
                    <select class="form-control select2" name="bulan1" id="bulan1" onchange="dataDaftarPointSDM();">
                      <?php
                      pilihBulan($bulan1);
                      ?>
                    </select>
                  ...
                  <div class="col-sm-2">
                    <label>Tahun</label>
                    <select class="form-control select2" name="tahun1" id="tahun1" onchange="dataDaftarPointSDM();">
                      <?php
                      pilihTahun($tahun1);
                      ?>
                    </select>
  ...
  <script src="js/pointsdm.js"></script>
