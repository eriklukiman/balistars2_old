...
<html>
<head>
  <title>Pembayaran Piutang <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPembayaranPiutang()">
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Pembayaran Piutang</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control form-control-lg" name="rentang" id="rentang" onchange="dataDaftarPembayaranPiutang()">
                  </div>
                  <!-- <div class="col-sm-2" <?=$style?>>
                    <label>Tipe</label>
                    <select name="tipe" id="tipeSearch" class="form-control select2"  onchange="dataDaftarPembayaranPiutang()" >
                      <?php
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarPembayaranPiutang()">
                          Tanggal 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarPembayaranPiutang"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalBoxPembayaranPiutang" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 80%">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h5 class="modal-title"> Form Pembayaran Piutang
           </h5>
          </div>
        ...
        <div class="modal-body" id="boxPembayaranPiutang"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/pembayaranpiutang.js"></script>
