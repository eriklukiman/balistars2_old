...
<html>
<head>
  <title>Neraca Lajur <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue">
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Neraca Lajur </h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-4" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control form-control-lg" name="rentang" id="rentang" onchange="dataDaftarNeracaLajur()">
                  </div>
                </div>
                <div style="overflow-x: auto;">
                  ...
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarNeracaLajur()">
                          Kode ACC
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarNeracaLajur"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <script src="js/neracalajur.js"></script>
