...
<html>
<head>
  <title>Biaya Cabang <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarBiayaCard()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Biaya Cabang</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header" style="background-color: lightblue;">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Biaya Cabang</h5>
                  </div>
                  <div class="col-sm-6">
                    <button type    = "button"
                            title   = "Print" 
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarBiayaCard()">
                  </div>
                  <?php 
                  ...
                  <div class="col-sm-3" >
                    <label>Cabang</label>
                    <select name="idCabang" id="idCabangSearch" class="form-control select2" style="width: 100%;" onchange="dataDaftarBiayaCard()">
                      <?php
                ...
                <div style="overflow-x: auto;">
                  <div id="dataDaftarBiayaCard"></div>
                </div>
              </div>
              <!-- End Body -->
            </div>
  ...
  <script src="js/biayacard.js"></script>
