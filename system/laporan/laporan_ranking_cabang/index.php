...
<html>
<head>
  <title>Laporan Ranking Cabang <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarRankingCabang()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Ranking Cabang</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Laporan Ranking Cabang</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-2">
                    <label>Bulan</label>
                    <select class="form-control select2" name="bulan" id="bulan" onchange="dataDaftarRankingCabang();">
                      <?php
                      pilihBulan($bulan);
                      ?>
                    </select>
                  ...
                  <div class="col-sm-2">
                    <label>Tahun</label>
                    <select class="form-control select2" name="tahun" id="tahun" onchange="dataDaftarRankingCabang();">
                      <?php
                      pilihTahun($tahun);
                      ?>
                    </select>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarRankingCabang()">
                          Cabang
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarRankingCabang"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <script src="js/rankingcabang.js"></script>
