...
<html>
<head>
  <title>Laporan Piutang History <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPiutangHistory()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Piutang History</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar PiutangHistory</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarPiutangHistory()">
                  </div>
                  <?php 
                  ...
                  <div class="col-sm-3" >
                    <label>Cabang</label>
                    <select name="idCabang" id="idCabangSearch" class="form-control select2" style="width: 100%;" onchange="dataDaftarPiutangHistory()">
                      <?php
                  ...
                  <div class="col-sm-2" <?=$style?>>
                    <label>Tipe</label>
                    <select name="tipe" id="tipeSearch" class="form-control select2"  onchange="dataDaftarPiutangHistory()" >
                      <?php
                ...
                <div style="overflow-x: auto;">
                  ...
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarPiutangHistory()">
                          No Nota
                        </button>
                      </th>
                      <th>
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarPiutangHistory('noNota')">
                          No Telepon 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarPiutangHistory"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormPiutangHistory" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 80%">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h5 class="modal-title">
             Form Edit Bank Piutang
           </h5>
          </div>
        ...
        <div class="modal-body" id="dataFormPiutangHistory"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/laporanpiutanghistory.js"></script>
