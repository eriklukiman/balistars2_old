...
<html>
<head>
  <title>Laporan Achievement <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarAchievement()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Laporan Achievement</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Laporan Achievement <span id="jamAnalog"></span> </h5> 
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarAchievement()">
                  </div>
                </div>
                <p>
                  Keterangan : <br>
                  <i class="fa fa-star fa-lg text-danger"></i> (Penjualan Paling Pagi)
                  <i class="fa fa-star fa-lg text-warning"></i> (Acv terbaik s/d jam 12.00)<br>
                  <i class="fa fa-star fa-lg text-success"></i> (Acv terbaik s/d jam 15.00)
                  <i class="fa fa-star fa-lg text-primary"></i> (Acv terbaik s/d jam 21.00)<br>
                </p>
                <div style="overflow-x: auto;">
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarAchievement()">
                          Cabang
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarAchievement"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
