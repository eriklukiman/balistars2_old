...
<html>
<head>
  <title>Komparation <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarKomparation()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Komparation</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Komparation</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarKomparation()">
                  </div>
                  <div class="col-sm-3">
                    <label>Jenis</label>
                    <select class="form-control select2" name="jenis" id="jenis" onchange="dataDaftarKomparation()">
                      <?php 
                      $arrayJenis = array('Penjualan','Pembelian Bahan','Piutang','Produktivity Indoor','Produktivity Outdoor','Produktivity Laser','Produktivity BW','Produktivity UV','Biaya Operasional','Biaya Advertising','Biaya Lain Lain+Promosi','Biaya Klik');
                      for($i=0; $i<count($arrayJenis); $i++){
                       ?>
                       <option value="<?=$arrayJenis[$i]?>"><?=$arrayJenis[$i]?></option>
                       <?php
                      }
                      ?>
                    </select>
                ...
                <div style="overflow-x: auto;">
                  <div id="dataDaftarKomparation"></div>
                </div>
              </div>
              <!-- End Body -->
            </div>
  ...
  <script src="js/komparation.js"></script>
