...
<html>
<head>
  <title>Penyusutan Aktiva <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPenyusutanAktiva()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Penyusutan Aktiva</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Laporan Penyusutan Aktiva</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-2">
                    <label>Bulan</label>
                    <select class="form-control select2" name="bulan1" id="bulan1" onchange="dataDaftarPenyusutanAktiva();">
                      <?php
                      pilihBulan($bulan1);
                      ?>
                    </select>
                  ...
                  <div class="col-sm-2">
                    <label>Tahun</label>
                    <select class="form-control select2" name="tahun1" id="tahun1" onchange="dataDaftarPenyusutanAktiva();">
                      <?php
                      pilihTahun($tahun1);
                      ?>
                    </select>
                ...
                <div style="overflow-x: auto;">
                  <div id="dataDaftarPenyusutanAktiva"></div>
                </div>
              </div>
              <!-- End Body -->
            </div>
  ...
  <div id="modalFormJualAktiva" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 80%">
      <div class="modal-content">
        ...
        <div class="modal-body" id="dataFormJualAktiva"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/penyusutanaktiva.js"></script>
