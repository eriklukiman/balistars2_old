...
<html>
<head>
  <title>Piutang <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPiutang()">
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Piutang</h5>
                  </div>
                  <div class="col-sm-6">
                    <button type    = "button"
                            title   = "Print" 
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control form-control-lg" name="rentang" id="rentang" onchange="dataDaftarPiutang()">
                  </div>
                  <?php 
                  ...
                  <div class="col-sm-3" >
                    <label>Cabang</label>
                    <select name="idCabang" id="idCabangSearch" class="form-control select2" style="width: 100%;" onchange="dataDaftarPiutang()">
                  ...
                  <div class="col-sm-2" <?=$style?>>
                    <label>Tipe</label>
                    <select name="tipe" id="tipeSearch" class="form-control select2"  onchange="dataDaftarPiutang()" >
                      <?php
                  ...
                  <div class="col-sm-3" >
                    ...
                    <select name="idCustomer" id="idCustomerSearch" class="form-control select2" style="width: 100%;" onchange="dataDaftarPiutang()">
                      ...
                      foreach($dataCustomer as $data){
                        ?>
                        <option value="<?=$data['idCustomer']?>" ><?=$data['namaCustomer']?></option>
                        <?php
                      }
                      ?>
                    </select>
                ...
                <div style="overflow-x: auto;">
                  ...
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarPiutang()">
                          No Nota 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarPiutang"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
