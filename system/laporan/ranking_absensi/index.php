...
<html>
<head>
  <title>Ranking Absensi <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarRankingAbsensi()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Ranking Absensi</li>
              </ul>
            </div>            
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Ranking Absensi</h5>
                  </div>
                  <div class="col-sm-6">
                    <button type    = "button"
                            title   = "Print" 
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    ...
                    <div class="input-group date"  data-date-autoclose="true" data-provide="datepicker"  data-date-format="dd-mm-yyyy">
                      <input type="tanggal" class="form-control" name="tanggal" id="tanggal" value="<?=date('d-m-Y')?>" onchange="dataDaftarRankingAbsensi()" autocomplete="off">
                ...
                <div style="overflow-x: auto;">
                  ...
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarRankingAbsensi('tanggalRankingAbsensi')">
                          Branch 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarRankingAbsensi('noNota')">
                          Nama 
                        </button>
                      </th>
                      <th style="text-align: center;">
                        <button class="btn btn-sm btn-info" onclick="dataDaftarRankingAbsensi()">
                          Poin 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarRankingAbsensi('grandTotal')">
                          Predikat 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarRankingAbsensi"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <script src="js/rankingabsensi.js"></script>
