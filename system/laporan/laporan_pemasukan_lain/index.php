...
<body class="theme-blue" onload="dataDaftarPemasukanLain()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Pemasukan Lain</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Pemasukan Lain</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control form-control-lg" name="rentang" id="rentang" onchange="dataDaftarPemasukanLain()">
                  </div>
                  <div class="col-sm-3">
                    <label>Tipe Pemasukan</label>
                    <select name="idKodePemasukan" id="idKodePemasukanSearch" class="form-control select2" onchange="dataDaftarPemasukanLain()"  required>
                        <option value="Semua"> Semua Pemasukan </option>
                        <?php
                        $sqlKode=$db->prepare('SELECT * 
                          FROM balistars_kode_pemasukan 
                          where statusKodePemasukan=?');
                        $sqlKode->execute(['Aktif']);
                        $dataKode=$sqlKode->fetchAll();
                        foreach($dataKode as $row){
                          ?>
                          <option value="<?=$row['idKodePemasukan']?>"> <?=$row['tipePemasukan']?> </option>
                          <?php
                        }
                        ?>
                      </select>
  ...
  <script src="js/pemasukanlain.js"></script>
