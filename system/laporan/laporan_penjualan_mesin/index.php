...
<html>
<head>
  <title>Laporan Penjualan Mesin <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPenjualanMesin()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Laporan Penjualan Mesin</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Laporan Penjualan Mesin</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarPenjualanMesin()">
                  </div>
                </div>
                <div style="overflow-x: auto;">
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarPenjualanMesin()">
                          Tanggal Penjualan
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarPenjualanMesin"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <script src="js/penjualanmesin.js"></script>
