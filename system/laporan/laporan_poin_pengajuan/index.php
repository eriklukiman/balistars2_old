...
?>
    ...
    <head>
        <title>Laporan Poin Pengajuan <?= $dataInformasi['nama'] ?></title>
        <meta charset="utf-8">
    ...
    ">
        ...
        <div id="wrapper">
            ...
            <div id="main-content">
                <div class="container-fluid">
                    ...
                    <div class="block-header">
                        <div class="row">
                            <div class="col-sm-12">
                                <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Laporan Poin Pengajuan <?= $dataInformasi['nama'] ?></h2>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="icon-home"></i></a></li>
                                    <li class="breadcrumb-item">Laporan Pengajuan</li>
                                    <li class="breadcrumb-item active">Laporan Poin Pengajuan</li>
                                </ul>
                            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card planned_task">
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class="col-sm-9">
                                            <h5><i class="fas fa-chart-line pr-4"></i> <strong>LAPORAN POIN PENGAJUAN</strong> </h5>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Header -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="datepicker" class="form-control form-control-lg" name="rentang" id="rentang" onchange="dataDaftarPoin()">
            ...
            <script src="js/poinpengajuan.js"></script>
