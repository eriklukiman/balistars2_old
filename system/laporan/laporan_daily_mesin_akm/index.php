...
<html>
<head>
  <title>Daily Mesin Akm <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarDailyMesinAkm()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Daily Mesin Akm</li>
              </ul>
            </div>            
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Laporan Daily Mesin Akm</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-4">
                    ...
                    <select class="form-control select2" id="jenisPenjualan">
                  ...
                  <div>
                    <label>&nbsp</label>
                    <div>
                      <button type="button" class="btn btn-info" onclick="dataDaftarDailyMesinAkm()"><i class="fas fa-search"></i></button>
                    </div> 
                  </div>
                </div>
                <div style="overflow-x: auto;">
                  <div id="dataDaftarDailyMesinAkm"></div>
                </div>
              </div>
              <!-- End Body -->
            </div>
  ...
  <script src="js/dailymesinakm.js"></script>
