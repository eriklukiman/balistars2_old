...
if($jenisPPN=='Include'){
 ...
 ?>
  ...
  <tr>
    ...
    <td style="text-align: right; padding-right: 23px;">
      <input type="text" class="form-control" name="pembayaran" placeholder="0" id="pembayaran" onkeyup="ubahToRp('#pembayaran'); getKembalian();statusKembalian();" value="<?=$pembayaran?>" style="text-align: right;">
    </td>
    <td></td>
  </tr>
  <tr>
    ...
    <td colspan="7" style="text-align: right;"></td>
     <td style="text-align: right;">
      <button class="btn btn-primary" onclick="prosesPenjualan();" <?=$disabled?> >
        <i class="fa fa-window-close"></i> Selesai
      </button>
    </td>
    <td></td>
  </tr> 
