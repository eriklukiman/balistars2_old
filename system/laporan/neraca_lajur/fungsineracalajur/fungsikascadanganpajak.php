<?php  
function kasCadanganPajak($total,$db,$tanggalAwal,$tanggalAkhir,$tipe)
{
	...
	$execute = array(
		'Cadangan pajak',
		'3115', 
		'Debet',$tanggalAwal,$tanggalAkhir,'Cadangan Pajak',
		'Kredit', $tanggalAwal,$tanggalAkhir, 'Cadangan Pajak',

    '3115', 
		'Saldo Awal',$tanggalAwal,$tanggalAkhir,'Cadangan Pajak',
