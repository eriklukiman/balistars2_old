...
<html>
<head>
  <title>Daily Mesin <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarDailyMesin()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Daily Mesin</li>
              </ul>
            </div>            
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Laporan Daily Mesin</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-4">
                    ...
                    <select class="form-control select2" id="jenisPenjualan"  onchange="dataDaftarDailyMesin();">
                  ...
                  <div class="col-sm-2">
                    <label>Bulan</label>
                    <select class="form-control select2" name="bulan1" id="bulan1" onchange="dataDaftarDailyMesin();">
                      <?php
                      pilihBulan($bulan1);
                      ?>
                    </select>
                  ...
                  <div class="col-sm-2">
                    <label>Tahun</label>
                    <select class="form-control select2" name="tahun1" id="tahun1" onchange="dataDaftarDailyMesin();">
                      <?php
                      pilihTahun($tahun1);
                      ?>
                    </select>
                ...
                <div style="overflow-x: auto;">
                  <div id="dataDaftarDailyMesin"></div>
                </div>
              </div>
              <!-- End Body -->
            </div>
  ...
  <script src="js/dailymesin.js"></script>
