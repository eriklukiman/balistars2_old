...
<html>
<head>
  <title>Laporan Produktivity <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarProduktivity()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Laporan Produktivity</li>
              </ul>
            </div>            
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Laporan Produktivity</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-4">
                    ...
                    <select class="form-control select2" id="jenisPenjualan"  onchange="dataDaftarProduktivity();">
                      <?php
                      $sqlPenjualan=$db->prepare('SELECT * 
                        FROM balistars_jenis_penjualan
                        where statusJenisPenjualan=?');
                      $sqlPenjualan->execute(['Aktif']);
                      $dataPenjualan=$sqlPenjualan->fetchAll();
                      foreach ($dataPenjualan as $row) {
                        ?>
                         <option value="<?=$row['jenisPenjualan']?>"><?=$row['jenisPenjualan']?></option>
                        <?php
                      }
                      ?>
                    </select>
                  ...
                  <div class="col-sm-2">
                    <label>Bulan</label>
                    <select class="form-control select2" name="bulan1" id="bulan1" onchange="dataDaftarProduktivity();">
                      <?php
                      pilihBulan($bulan1);
                      ?>
                    </select>
                  ...
                  <div class="col-sm-2">
                    <label>Tahun</label>
                    <select class="form-control select2" name="tahun1" id="tahun1" onchange="dataDaftarProduktivity();">
                      <?php
                      pilihTahun($tahun1);
                      ?>
                    </select>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarProduktivity()">
                          Cabang 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarProduktivity"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <script src="js/produktivity.js"></script>
