...
$dataCabangCash=$db->query('SELECT * FROM balistars_cabang_cash inner join balistars_cabang on balistars_cabang_cash.idCabang=balistars_cabang.idCabang order by balistars_cabang_cash.tanggalCabangCash');
...
foreach($dataCabangCash as $row){
  ...
  <tr>
    ...
    <td><?=wordwrap(ubahTanggalIndo($row['tanggalCabangCash']),50,'<br>')?></td>
