...
<html>
<head>
  <title> Penjualan Faktur Pajak <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPenjualanFakturPajak()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Penjualan Faktur Pajak</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Penjualan Faktur Pajak</h5>
                  </div>
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3">
                    <label>Cabang</label>
                    <select class="form-control select2" id="idCabang" onchange="dataDaftarPenjualanFakturPajak()">
                  ...
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarPenjualanFakturPajak()">
                  </div>
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarPenjualanFakturPajak()">
                          Tanggal Penjualan 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarPenjualanFakturPajak"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormPenjualanFakturPajak" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg" style="max-width : 70%">
      <div class="modal-content">
        ...
        <div class="modal-body" id="dataFormPenjualanFakturPajak"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/penjualanfakturpajak.js"></script>
