...
<html>
<head>
  <title>Form Kasir <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarFinalisasi('noNota')">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Form Kasir</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  ...
                  <!-- <div class="col-sm-3 text-right"> 
                    <button type               = "button" 
                              title              = "Kasir Umum A1"
                              class              = "btn btn-primary tombolKasir" 
                              style              = "color: white; right: auto;"
                              onclick = "formKasir('A1','umum')">
                        <i>U1</i>
                      </button>
                      <button type               = "button" 
                              title              = "Kasir Umum A2"
                              class              = "btn btn-primary tombolKasir" 
                              style              = "<?=$style?>"
                              onclick = "formKasir('A2','umum')">
                        <i>U2</i>
                      </button>
                      <button type               = "button" 
                              title              = "Kasir Pelanggan A1"
                              class              = "btn btn-primary tombolKasir" 
                              style              = "color: white; right: auto;"
                              onclick = "formKasir('A1','pelanggan')">
                        <i>P1</i>
                      </button>
                      <button type               = "button" 
                              title              = "Kasir Pelanggan A2"
                              class              = "btn btn-primary tombolKasir" 
                              style              = "<?=$style?>"
                              onclick = "formKasir('A2','pelanggan')">
                        <i>P2</i>
                      </button>
                  </div> -->
                </div>
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarFinalisasi()">
                  </div>
                </div>
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    ...
                    <tbody id="dataDaftarFinalisasi"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormKasir" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 90%">
      <div class="modal-content">
        ...
        <div class="modal-body" id="dataFormKasir"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/finalisasipenjualan.js"></script>
