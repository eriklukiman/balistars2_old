...
<html>
<head>
  <title> Persediaan Global <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPersediaanGlobal()">
  <div id="wrapper">
    <?php
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Persediaan Global</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Persediaan Global</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahPersediaanGlobal" type="button" class="btn btn-info" onclick="tambahPersediaanGlobal()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Persediaan Global Baru
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="row form-group" >
                  <div class="col-sm-3">
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang"  onchange="dataDaftarPersediaanGlobal()">
                  </div>
                  <div class="col-sm-3" >
                    <label>Cabang</label>
                    <select name="idCabangSearch" id="idCabangSearch" class="form-control select2" style="width: 100%;" onchange="dataDaftarPersediaanGlobal()">
                      <?php
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarPersediaanGlobal()">
                          Tanggal
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarPersediaanGlobal"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormPersediaanGlobal" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 75%">
      <div class="modal-content">
        ...
        <div class="modal-body" id="dataFormPersediaanGlobal"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/persediaanglobal.js"></script>  
</body>
</html>