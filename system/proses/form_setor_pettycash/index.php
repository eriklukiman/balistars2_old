...
<html>
<head>
  <title> Setor Petty Cash <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Setor Petty Cash</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Setor Petty Cash</h5>
                  </div>
              ...
              <div class="body">
                ...
                <div class="form-group" >
                  <label>Rentang</label>
                  <input type="datepicker" class="form-control" name="rentang" id="rentang" style="width : 25%" onchange="dataDaftarSetorPettyCash()">
                </div>
