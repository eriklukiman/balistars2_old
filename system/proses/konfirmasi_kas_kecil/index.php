...
<html>
<head>
  <title> Konfirmasi Kas Kecil <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarKonfirmasiKasKecil()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Konfirmasi Kas Kecil</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Konfirmasi Kas Kecil</h5>
                  </div>
                  <!-- <div class="col-sm-6 text-right">
                    <button id="tombolTambahTarget" type="button" class="btn btn-info" onclick="tambahTarget()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Target Baru
                    </button>
                  </div> -->
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3">
                    <label>Cabang</label>
                    <select class="form-control select2" id="idCabang" onchange="dataDaftarKonfirmasiKasKecil()">
                      <option value="0">Pilih Cabang</option>
                      <?php  
                      $sqlCabang = $db->prepare('SELECT * FROM balistars_cabang WHERE statusCabang=?');
                  ...
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control form-control-lg" name="rentang" id="rentang" onchange="dataDaftarKonfirmasiKasKecil()">
                  </div>
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarKonfirmasiKasKecil()">
                          Tanggal Order 
                        </button>
                      </th>
                      <th>
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarKonfirmasiKasKecil(target)">
                          Nilai Order (Rp) 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarKonfirmasiKasKecil"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormKonfirmasiKasKecil" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg" style="max-width : 70%">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h5 class="modal-title">
             Konfirmasi Kas Kecil
           </h5>
          </div>
        ...
        <div class="modal-body" id="dataFormKonfirmasiKasKecil"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/konfirmasikaskecil.js"></script>
