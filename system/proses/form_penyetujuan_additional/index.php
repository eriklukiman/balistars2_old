...
?>
    ...
    <head>
        <title>Form Penyetujuan Additional <?= $dataInformasi['nama'] ?></title>
        <meta charset="utf-8">
    ...
    ">
        ...
        <div id="wrapper">
            ...
            <div id="main-content">
                <div class="container-fluid">
                    ...
                    <div class="block-header">
                        <div class="row">
                            <div class="col-sm-12">
                                <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Form Penyetujuan Additional <?= $dataInformasi['nama'] ?></h2>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="icon-home"></i></a></li>
                                    <li class="breadcrumb-item">Penyetujuan</li>
                                    <li class="breadcrumb-item active">Form Penyetujuan Additional</li>
                                </ul>
                            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card planned_task">
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class="col-sm-9">
                                            <h5><i class="fas fa-check-circle pr-4"></i> <strong>FORM PENYETUJUAN ADDITIONAL</strong> </h5>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Header -->
                                ...
                                <div class="body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="datepicker" class="form-control form-control-lg" name="rentang" id="rentang" onchange="dataDaftarAdditional()">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="status" id="status" class="select2 form-control" onchange="dataDaftarAdditional()">
                                    ...
                                    <div id="dataDaftarAdditional"></div>
            ...
            <div id="modalProgressAdditional" class="modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="col-sm-11">
                                <h5 class="modal-title">
                                    <strong>PROGRESS ADDITIONAL</strong>
                                </h5>
                            </div>
                        ...
                        <div class="modal-body" id="boxProgressAdditional"></div>
                    </div>
                </div>
            </div>
