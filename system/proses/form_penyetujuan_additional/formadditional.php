        ...
        <div class="row">
            ...
            <div class="col-md-4 form-group">
                ...
                <div class="d-flex" style="flex-direction: column; gap: 10px">
                    <button type="button" class="w-75 btn btn-success" onclick="prosesPenyetujuan($(this), '<?= $idAdditional ?>', 'Disetujui')">
                        <strong>DISETUJUI</strong>
                    </button>
                    <button type="button" class="w-75 btn btn-danger" onclick="prosesPenyetujuan($(this), '<?= $idAdditional ?>', 'Reject')">
