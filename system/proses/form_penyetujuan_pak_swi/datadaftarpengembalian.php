                ...
                if (isset($tanggal[0]) && isset($tanggal[1])) {
                    ...
                    foreach ($dataPengembalian as $row) {
                        ...
                        switch ($status) {
                            ...
                            case 'Disetujui':
                                $cekHasil = selectStatement(
                                    ...
                                    [$row['idPengembalian'], $jenisPengajuan, 'Aktif', 'Pak Swi'],
                                    'fetch'
                                )['hasil'];
                        ...
                        $dataProses = selectStatement(
                            ...
                            ",
                            [
                                'Pak Swi', $row['idPengembalian'], $row['attempt'],  $jenisPengajuan, 'Aktif'
                            ],
                            'fetch'
                        );
                ?>
                        <tr>
                            ...
                            <td class="text-center" class="align-middle">
                                ...
                                <?php
                                if (in_array('Pak Swi', $tahapan) && $row['tahapan'] === 'Pak Swi') {
                                ?>
                            ...
                            <td class="text-center">
                                ...
                                if ($dataProses) {
                                ?>
                                    <span><?= $dataProses['waktuProses']; ?></span>
                                    <br />
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-info" onclick="showProgressPenyetujuan('<?= $jenisPengajuan ?>','<?= $row['idPengembalian'] ?>')"><strong>CEK STATUS</strong></button>
                            </td>
                        </tr>
                    <?php
                        $n++;
