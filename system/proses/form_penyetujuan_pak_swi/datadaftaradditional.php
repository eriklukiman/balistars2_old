                        ...
                        switch ($status) {
                            ...
                            case 'Disetujui':
                                $cekHasil = selectStatement(
                                    ...
                                    [$row['idAdditional'], $jenisPengajuan, 'Aktif', 'Pak Swi'],
                                    'fetch'
                                )['hasil'];
                ...
                ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <button type="button" class="btn btn-info" onclick="showProgressPenyetujuan('<?= $jenisPengajuan ?>','<?= $row['idAdditional'] ?>')"><strong>CEK STATUS</strong></button>
                            </td>
                        </tr>
                    <?php
                        $n++;
