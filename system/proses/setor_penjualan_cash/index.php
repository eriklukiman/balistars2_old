...
<html>
<head>
  <title> Setor Penjualan Cash <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarSetorPenjualanCash()">
  <div id="wrapper">
    <?php
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Setor Penjualan Cash</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Setor Penjualan Cash</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group" >
                  <div class="col-sm-3">
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarSetorPenjualanCash()">
                  </div>
                  <div class="col-sm-3">
                    <label>Cabang</label>
                    <select class="form-control select2" id="idCabang" onchange="dataDaftarSetorPenjualanCash()">
                  ...
                  <div class="col-sm-2" <?=$style?>>
                    <label>Tipe</label>
                    <select name="tipe" id="tipe" class="form-control select2"  onchange="dataDaftarSetorPenjualanCash()" >
                      <?php
                      $arrayTipe=array('Semua','A1','A2');
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarSetorPenjualanCash()">
                          Tanggal Setor
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarSetorPenjualanCash"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormSetorPenjualanCash" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 75%">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h5 class="modal-title">
              Setor Penjualan Cash
            </h5>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormSetorPenjualanCash"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/setorpenjualancash.js"></script>  
