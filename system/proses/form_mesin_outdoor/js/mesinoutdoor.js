function dataDaftarMesinOutdoor(){
  //console.log($('#parameterOrder').val());
  $.ajax({
    url:'datadaftarmesinoutdoor.php',
    type:'post',
    data:{
    ...
    success:function(data,status){
      $('#dataDaftarMesinOutdoor').empty().append(data);
...
function editMesinOutdoor(id){

    $.ajax({
      url:'prosesmesinoutdoor.php',
      type:'post',
      data:{
        flag : 'cancel',
        idPerformaOutdoor : id,
      },

      success:function(data,status){
        // console.log(data);
        let dataJSON = JSON.parse(data);
        dataDaftarMesinOutdoor(dataJSON.parameterOrder);
...
function prosesMesinOutdoor(id){
