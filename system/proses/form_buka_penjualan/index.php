...
<html>
<head>
  <title> Buka Penjualan <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Buka Penjualan</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header" style="background-color: lightblue;">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Buka Penjualan</h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              <!-- Body -->
              <div class="body">
                <form id="formBukaPenjualan">
                  <div class="form-group">
                    <label>No Nota yang akan dibuka</label>
                    <input type="text" name="noNota" id="noNota" class="form-control form-control-lg" placeholder="Input No Nota">
                  </div>
                  <div class="form-group">
                    <button type="button" class="btn btn-primary" onclick="prosesBukaPenjualan()">
  ...
  <script src="js/bukapenjualan.js"></script>
</body>
</html>