...
<html>
<head>
  <title>Form Biaya <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="tambahBiaya('A1','')">
              ...
              <div class="header" style="background-color: lightblue;">
                <div class="row">
                  <div class="col-sm-9">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Form Biaya </h5>
                  </div>
                  <div class="col-sm-3 text-right">
                    <button type               = "button" 
                            title              = "Biaya A1"
                            class              = "btn btn-success tombolBiaya" 
                            style              = "color: white; right: auto;"
                            onclick = "tambahBiaya('A1','')">
                      <i>U1</i>
                    </button>
                    <button type               = "button" 
                            title              = "Biaya A2"
                            class              = "btn btn-primary tombolBiaya" 
                            style              = "<?=$style?>"
                            onclick = "tambahBiaya('A2','')">
                      <i>U2</i>
                    </button>
                  </div>
                </div>
  ...
  <script src="js/formbiaya.js"></script>
