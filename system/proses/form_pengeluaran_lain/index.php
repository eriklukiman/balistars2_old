...
<html>
<head>
  <title> Pengeluaran Lain <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPengeluaranLain()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Pengeluaran Lain</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <?php 
                    $sqlMenu = $db->prepare('SELECT * FROM balistars_user_detail inner join balistars_menu_sub ON balistars_menu_sub.idMenuSub=balistars_user_detail.idMenuSub WHERE idUser=? and namaMenuSub=?');
                    $sqlMenu->execute([$idUserAsli,'Pengeluaran Lain']);
                    $dataMenu=$sqlMenu->fetch();
                    $style='';
                    if($dataMenu['tipeA2']=='0'){
                         $style = 'display: none;';
                    }
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Pengeluaran Lain
                    </h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <select name="tipe" id="tipe" class="btn btn-info"  onchange="dataDaftarPengeluaranLain()" style="<?=$style?>">
                      <?php
                    ...
                    <button id="tombolTambahPengeluaranLain" type="button" class="btn btn-info" onclick="tambahPengeluaranLain()" >
                      <i class="fa fa-plus"></i> Pengeluaran Lain Baru
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarPengeluaranLain()">
                  </div>
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarPengeluaranLain()">
                          Tanggal Pengeluaran 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarPengeluaranLain"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormPengeluaranLain" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Pengeluaran Lain
            </h4>
          </div>
        ...
        <div class="modal-body" id="dataFormPengeluaranLain"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/formpengeluaranlain.js"></script>
