...
<body class="theme-blue" onload="formKasir('A2','umum')">
              ...
              <div class="header" style="background-color: lightblue;">
                <div class="row">
                  <div class="col-sm-9">
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Form kasir </h5>
                  </div>
                  <div class="col-sm-3 text-right"> 
                    <button type               = "button" 
                      ...
                      <button type               = "button" 
                              title              = "Kasir Umum A2"
                              class              = "btn btn-success tombolKasir" 
                              style              = "<?=$style?>"
  ...
  <script src="js/formkasir.js"></script>
