...
<html>
<head>
  <title> Penyusutan <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPenyusutan()">
            ...
            <div class="card planned_task">
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3">
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarPenyusutan()">
                  </div>
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarPenyusutan()">
                          Tanggal Penyusutan 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarPenyusutan"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormPenyusutan" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Penyusutan Cabang
            </h4>
          </div>
          <div class="col-sm-1">
        ...
        <div class="modal-body" id="dataFormPenyusutan"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/penyusutan.js"></script>
</body>
</html>