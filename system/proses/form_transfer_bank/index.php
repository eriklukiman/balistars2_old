...
<html>
<head>
  <title> Transfer Antar Bank <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarTransferBank()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Transfer Antar Bank</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    $sqlMenu->execute([$idUserAsli,'Transfer Antar Bank']);
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Transfer Antar Bank
                    </h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <select name="tipe" id="tipe" class="btn btn-info"  onchange="dataDaftarTransferBank()" style="<?=$style?>">
                      <?php
                    ...
                    <button id="tombolTambahTransferBank" type="button" class="btn btn-info" onclick="tambahTransferBank()">
                      <i class="fa fa-plus"></i> Transfer Antar Bank Baru
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarTransferBank()">
                  </div>
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarTransferBank()">
                          Tanggal Transfer 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarTransferBank"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormTransferBank" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Transfer Antar Bank
            </h4>
          </div>
        ...
        <div class="modal-body" id="dataFormTransferBank"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/formtransferbank.js"></script>
</body>
</html>