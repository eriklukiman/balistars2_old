...
<html>
<head>
  <title> Sewa Gedung <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarSewaGedung()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Sewa Gedung</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar SewaGedung</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahSewaGedung" type="button" class="btn btn-info" onclick="tambahSewaGedung()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Sewa Gedung Baru
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarSewaGedung()">
                          Gedung 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarSewaGedung"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormSewaGedung" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 80%">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Sewa Gedung
            </h4>
          </div>
        ...
        <div class="modal-body" id="dataFormSewaGedung"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/sewagedung.js"></script>
</body>
</html>