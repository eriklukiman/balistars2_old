...
<html>
<head>
  <title> Saldo Awal <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarSaldoAwal()">
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Saldo Awal
                      <a href="<?=$BASE_URL_HTML?>/system/proses/form_saldo_awal_cabang" class="btn btn-primary">
                        <i>Cash</i>
                      </a>
                      <a href="<?=$BASE_URL_HTML?>/system/proses/form_saldo_awal_cabang_pety" class="btn btn-primary">
                        <i>Pety</i>
                      </a>
                    </h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahSaldoAwal" type="button" class="btn btn-info" onclick="tambahSaldoAwal()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Saldo Awal Baru
                    </button>
                  </div>
                </div>
              </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarSaldoAwal()">
                          Tanggal Pemasukan 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarSaldoAwal"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormSaldoAwal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <h4 class="modal-title">
            <i class="fa fa-user"></i> Saldo Awal
          </h4>
        </div>
        <div class="modal-body" id="dataFormSaldoAwal"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/formsaldoawal.js"></script>
</body>
</html>