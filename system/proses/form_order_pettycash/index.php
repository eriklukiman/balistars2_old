...
<html>
<head>
  <title> Order Petty Cash <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarOrderPettyCash()">
  <div id="wrapper">
    <?php
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Order Petty Cash</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Order Petty Cash</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahOrderPettyCash" type="button" class="btn btn-info" onclick="tambahOrderPettyCash()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Order Petty Cash Baru
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="form-group" >
                  <label>Rentang</label>
                  <input type="datepicker" class="form-control" name="rentang" id="rentang" style="width : 25%" onchange="dataDaftarOrderPettyCash()">
                </div>
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarOrderPettyCash()">
                          Tanggal Order 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarOrderPettyCash"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormOrderPettyCash" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 75%">
      <div class="modal-content">
        ...
        <div class="modal-body" id="dataFormOrderPettyCash"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/orderpettycash.js"></script>  
