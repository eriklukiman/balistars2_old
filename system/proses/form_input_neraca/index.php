...
<html>
<head>
  <title> Input Neraca <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarInputNeraca()">
  <div id="wrapper">
    <?php
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Input Neraca</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahInputNeraca" type="button" class="btn btn-info" onclick="tambahInputNeraca()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Input Neraca Baru
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="row form-group" >
                  <div class="col-sm-3">
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarInputNeraca()">
                  </div>
                  <div class="col-sm-3">
                    <label>Tipe Biaya</label>
                    <select name="tipeBiaya" id="tipeBiayaSearch" class="form-control select2" onchange="dataDaftarInputNeraca()">
                      <?php 
                      $arrayTipe=array('Modal Awal','Laba Ditahan','Cadangan Pajak','Advertising');
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarInputNeraca()">
                          Tanggal 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarInputNeraca"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormInputNeraca" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 75%">
      <div class="modal-content">
        ...
        <div class="modal-body" id="dataFormInputNeraca"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/inputneraca.js"></script>  
</body>
</html>