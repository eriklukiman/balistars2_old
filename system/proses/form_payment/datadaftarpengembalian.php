                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center" class="align-middle">
                                <button type="button" class="btn btn-warning" onclick="showFormPengajuan('Pengembalian','<?= $row['idPengembalian'] ?>')">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <?php
                                if ($row['tahapan'] === 'Payment') {
                                ?>
                                    <button type="button" class="btn btn-success" onclick="getFormPayment('Pengembalian','<?= $row['idPengembalian'] ?>')">
                                        <i class="fas fa-calendar-check"></i>
                                    </button>
                                <?php
                                } else {
                                ?>
                                    <button type="button" class="btn btn-info" onclick="getFormPayment('Pengembalian','<?= $row['idPengembalian'] ?>')">
                                        <i class="fas fa-calendar-check"></i>
                                    </button>
                                <?php
                                }
