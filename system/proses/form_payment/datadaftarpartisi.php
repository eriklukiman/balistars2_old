                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center" class="align-middle">
                                <button type="button" class="btn btn-warning" onclick="showFormPengajuan('Partisi','<?= $row['idPartisi'] ?>')">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <?php
                                if ($row['tahapan'] === 'Payment') {
                                ?>
                                    <button type="button" class="btn btn-success" onclick="getFormPayment('Partisi','<?= $row['idPartisi'] ?>')">
                                        <i class="fas fa-calendar-check"></i>
                                    </button>
                                <?php
                                } else {
                                ?>
                                    <button type="button" class="btn btn-info" onclick="getFormPayment('Partisi','<?= $row['idPartisi'] ?>')">
                                        <i class="fas fa-calendar-check"></i>
                                    </button>
                                <?php
                                }
