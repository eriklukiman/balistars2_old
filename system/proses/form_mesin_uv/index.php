...
<html>
<head>
  <title> Performa Mesin UV <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMesinUV()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Performa Mesin UV</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Performa Mesin UV</h5>
                  </div>
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarMesinUV()">
                  </div>
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMesinUV()">
                          Tanggal Order 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarMesinUV"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMesinUV" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg" style="max-width : 70%">
      <div class="modal-content">
        ...
        <div class="modal-body" id="dataFormMesinUV"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/mesinuv.js"></script>
