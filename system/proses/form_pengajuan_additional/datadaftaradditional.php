            ...
            if (isset($tanggal[0]) && isset($tanggal[1])) {
                ...
                switch ($status) {
                    ...
                    case 'Sudah Diproses':
                        ...
                        break;
                    case 'Reject':
                        $parameter['status'] = 'AND data_penyetujuan.totalData > 0 AND balistars_pengajuan_additional.tahapan = \'Reject\'';
                        break;
                ...
                $dataAdditional = selectStatement(
                    ...
                    ",
                    array_merge(['Additional', 'Aktif', 'Aktif', $dataLogin['idCabang'], $tanggalAwal, $tanggalAkhir])
                );
