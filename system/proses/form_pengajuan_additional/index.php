...
?>
    ...
    <head>
        <title>Form Pengajuan Additional <?= $dataInformasi['nama'] ?></title>
        <meta charset="utf-8">
            ...
            <div id="main-content">
                <div class="container-fluid">
                    ...
                    <div class="block-header">
                        <div class="row">
                            <div class="col-sm-12">
                                <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Form Pengajuan Additional <?= $dataInformasi['nama'] ?></h2>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#"><i class="icon-home"></i></a></li>
                                    <li class="breadcrumb-item">Pengajuan</li>
                                    <li class="breadcrumb-item active">Form Pengajuan Additional</li>
                                </ul>
                            </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card planned_task">
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class="col-sm-9">
                                            <h5><i class="fas fa-sticky-note pr-4"></i> <strong>FORM PENGAJUAN ADDITIONAL</strong> </h5>
                                        </div>
                                    </div>
                                </div>
                                <!-- End Header -->
                                ...
                                <div class="body">
                                    ...
                                    <div id="dataDaftarAdditional" style="overflow-x: auto;">
                                    </div>
                        ...
                        <div class="modal-header">
                            <div class="col-sm-11">
                                <h5 class="modal-title">
                                    <strong>PROGRESS PENGAJUAN ADDITIONAL</strong>
                                </h5>
                            </div>
