...
<html>
<head>
  <title> Performa Mesin BW <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMesinBW()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Performa Mesin BW</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Performa Mesin BW</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahMesinBW" type="button" class="btn btn-info" onclick="tambahMesinBW()" style="height: 40px;">
              ...
              <div class="body">
                ...
                <div class="form-group col-sm-3">
                  <label>Rentang</label>
                  <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarMesinBW()">
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMesinBW('tanggalPerforma')">
                          Tanggal 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMesinBW()">
                          Klik Before
                        </button>
                      </th>
                      <th>
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMesinBW('jumlahKlik')">
                          Jumlah Klik 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMesinBW"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMesinBW" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Performa Mesin BW
            </h4>
          </div>
        ...
        <div class="modal-body" id="dataFormMesinBW"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/mesinbw.js"></script>
