...
<html>
<head>
  <title> Mesin Input <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMesinInput()">
  <div id="wrapper">
    <?php
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Performa Mesin </li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Job Order</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahAchievement" type="button" class="btn btn-info" onclick="tambahMesinInput()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Job Order
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="row form-group" >
                  <div class="col-sm-3">
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarMesinInput()">
                  </div>
                  <div class="col-sm-3">
                    <label>Jenis Order</label>
                    <select name="jenisOrder" class="form-control select2" id="jenisOrderSearch" onchange="dataDaftarMesinInput()">
                      <?php
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMesinInput()">
                          Jenis Order 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarMesinInput"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMesinInput" class="modal fade" role="dialog">
    <div class="modal-dialog" style="max-width: 75%">
      <div class="modal-content">
        ...
        <div class="modal-body" id="dataFormMesinInput"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/mesininput.js"></script>  
