...
//$rentang='01-'.date('m-Y').' - '.date('d-m-Y');
extract($_REQUEST);
...
<html>
<head>
  <title> Performa Mesin laser <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMesinLaser()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Performa Mesin laser</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Performa Mesin Laser</h5>
                  </div>
                  <div class="col-sm-6 text-right">
                    <button id="tombolTambahMesinLaser" type="button" class="btn btn-info" onclick="tambahMesinLaser()" style="height: 40px;">
                      <i class="fa fa-plus"></i> Klik Baru
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="form-group col-sm-3">
                  <label>Rentang</label>
                  <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarMesinLaser()">
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMesinLaser('tanggalPerforma')">
                          Tanggal 
                        </button>
                      </th>
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMesinLaser()">
                          Klik Before
                        </button>
                      </th>
                      <th>
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMesinLaser('jumlahKlik')">
                          Jumlah Klik 
                        </button>
                      </th>
                    </thead>
                    <tbody id="dataDaftarMesinLaser"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMesinLaser" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Performa Mesin Laser
            </h4>
          </div>
        ...
        <div class="modal-body" id="dataFormMesinLaser"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/mesinlaser.js"></script>
