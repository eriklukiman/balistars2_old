...
<html>
<head>
  <title> Laporan PO <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPo('noPo')">
    ...
    <div id="main-content">
      <div class="container-fluid">
        ...
        <div class="block-header">
          <div class="row">
            <div class="col-sm-12">                        
              <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Laporan Pre Order <?=$dataInformasi['nama']?></h2>
              <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="#"><i class="icon-home"></i></a></li>
                <li class="breadcrumb-item active">Pre Order <?=$dataLogin['namaCabang']?> </li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-12">
                    <h5><i class="fa fa-list"></i> Daftar Pre Order <?=$dataLogin['namaCabang']?></h5>
                  </div>
                </div>
              </div>
              <!-- End Header -->
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="text" class="form-control" name="rentang" value="<?=$rentang?>" id="rentang" onchange="dataDaftarPo()">
                  </div>
                </div>
                  ...
                  <table class="table table-bordered table-custom">
                    <thead class="bg-info text-white">
                      <tr>
                        ...
                        <th class="align-middle" rowspan="2">Nomor PO</th>
                        <th class="align-middle" rowspan="2">Nomor Nota</th>
                        <th class="align-middle" rowspan="2">Tanggal</th>
                        <th class="align-middle" rowspan="2">Customer</th>
                        <th class="align-middle" rowspan="2">Nomor Telp</th>
                        <th class="align-middle" rowspan="2">Cabang Advertising</th>
                        <th class="align-middle" rowspan="2">Status</th>
                        <th class="align-middle" rowspan="2">Selesai</th>
                        <th class="align-middle" colspan="8" style="text-align: center;">Detail</th>
                      </tr>
  ...
  <div id="modalFormTambahNoNota" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h5 class="modal-title">
             <i class="fa fa-user"> Input No Nota </i>
           </h5>
          </div>
        ...
        <div class="modal-body" id="dataFormTambahNoNota"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/laporanpo.js"></script>
