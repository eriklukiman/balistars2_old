...
foreach ($dataItemPembelian as $row) {
  ...
  <tr>
    ...
    <td style="vertical-align: top;">
      <button type="button" class="btn btn-danger" onclick="cancelBarang('<?=$row['idPembelianDetail']?>','<?=$konsumen?>','<?=$tipe?>')">
        <i class="fa fa-trash"></i>
      </button>
      <button type="button" class="btn btn-warning" onclick="editBarang('<?=$row['idPembelianDetail']?>','<?=$konsumen?>','<?=$tipe?>')">
