...
<body class="theme-blue" onload="tambahPembelian('A2','Cash')">
    ...
    <div id="main-content">
      <div class="container-fluid">
        ...
        <div class="block-header">
          <div class="row">
            <div class="col-sm-12">                        
              <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Form Pembelian  <?=$dataInformasi['nama']?></h2>
              <ul class="breadcrumb">
              ...
              <div class="header" style="background-color: lightblue;">
                <div class="row">
                  ...
                  <div class="col-sm-3 text-right">
                    <button type               = "button" 
                            title              = "Pembelian Cash A1"
                            class              = "btn btn-primary tombolPembelian" 
                            style              = "color: white; right: auto;"
                            onclick = "tambahPembelian('A1','Cash')">
                      <i>U1</i>
                    </button>
                    <button type               = "button" 
                            title              = "Pembelian Cash A2"
                            class              = "btn btn-success tombolPembelian" 
                            style              = "<?=$style?>"
                            onclick = "tambahPembelian('A2','Cash')">
                      <i>U2</i>
                    </button>
                    <button type               = "button" 
                            title              = "Pembelian Giro A1"
                            class              = "btn btn-primary tombolPembelian" 
                            style              = "color: white; right: auto;"
                            onclick = "tambahPembelian('A1','Giro')">
                      <i>S1</i>
                    </button>
                    <button type               = "button" 
                            title              = "Pembelian Giro A2"
                            class              = "btn btn-primary tombolPembelian" 
                            style              = "<?=$style?>"
                            onclick = "tambahPembelian('A2','Giro')">
                      <i>S2</i>
                    </button>
                  </div>
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-bordered table-custom">
                    <tr class="alert alert-info">
                      ...
                      <td rowspan="2">No Nota</td>
                      <td rowspan="2">No Nota Vendor</td>
                      <td rowspan="2"></td>
                      <td colspan="4" style="text-align: center;">Detail</td>
                      <td rowspan="2">Grand Total</td>
                      <td rowspan="2">DPP/PPN</td>
