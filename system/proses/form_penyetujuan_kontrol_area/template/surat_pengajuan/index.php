    ...
    <body>
        ...
        ?>
            ...
            <section id="tools">
                ...
                if ($isPreview) {
                ?>
                    <a class="btn btn-info btn-print-preview" href="<?= $BASE_URL_HTML ?>/system/proses/form_penyetujuan_kontrol_area/template/surat_pengajuan/?id=<?= $idPengajuan ?>" title="Ubah Ke Tampilan Print"><i class="fas fa-print pr-4"></i><strong>UBAH KE TAMPILAN PRINT</strong></a>
                <?php
                } else {
                ?>
                    <a class="btn btn-info btn-print-preview" href="<?= $BASE_URL_HTML ?>/system/proses/form_penyetujuan_kontrol_area/template/surat_pengajuan/?id=<?= $idPengajuan ?>&preview" title="Ubah Ke Tampilan Preview"><i class="fas fa-eye pr-4"></i><strong>UBAH KE TAMPILAN PREVIEW</strong></a>
                    <button class="btn btn-success" type="button" title="Print Halaman Ini" onclick="window.print()"><i class="fas fa-print pr-4"></i><strong>PRINT HALAMAN INI</strong></button>
                <?php
                }
                ?>
            </section>
