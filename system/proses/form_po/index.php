...
<html>
<head>
  <title> Form PO  <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="formPreorder('<?=$konsumen?>','<?=$flag?>','<?=$noPo?>','<?=$rentang?>')">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Form Pre Order</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row alert alert-info">
                  <div class="col-sm-9">
                    <h5><i class="fa fa-list"></i> Pre Order  Balistars <?=$dataLogin['namaCabang']?></h5>
                  </div>
                  <?php 
                  if($noPo==''){ ?>
                  <div class="col-sm-3 text-right">
                    <button type               = "button" 
                            title              = "PO Umum"
                            class              = "btn btn-success tombolPO" 
                            style              = "color: white; right: auto;"
                            onclick = "formPreorder('umum')">
                      <i>U</i>
                    </button>
                    <button type               = "button" 
                            title              = "PO Pelanggan"
                            class              = "btn btn-primary tombolPO" 
                            style              = "<?=$style?>"
                            onclick = "formPreorder('pelanggan')">
                      <i>P</i>
                    </button>
                  </div>
                <?php } ?>
                </div>
                <div class="body" id="dataFormPreorder">
  ...
  <script src="js/formpreorder.js"></script>
  <script>
    $(function(){
      $('.select2').select2();
    })
