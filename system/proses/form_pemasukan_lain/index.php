...
<html>
<head>
  <title> Pemasukan Lain <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPemasukanLain('')">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"> Pemasukan Lain</li>
              </ul>
            </div>            
            ...
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    $sqlMenu->execute([$idUserAsli,'Pemasukan Lain']);
                    ...
                    ?>
                    <h5><i class="fa fa-list"></i> Daftar Pemasukan Lain
                    </h5>
                  </div>
                   <div class="col-sm-6 text-right">
                    <select name="tipe" id="tipe" class="btn btn-info"  onchange="dataDaftarPemasukanLain()" style="<?=$style?>" >
                      <?php
                    ...
                    <button id="tombolTambahPemasukanLain" type="button" class="btn btn-info" onclick="tambahPemasukanLain()" >
                      <i class="fa fa-plus"></i> Pemasukan Lain Baru
                    </button> 
                  </div>
                </div>
              </div>
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarPemasukanLain()">
                  </div>
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarPemasukanLain()">
                          Tanggal Pemasukan 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarPemasukanLain"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormPemasukanLain" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h4 class="modal-title">
              <i class="fa fa-user"></i> Pemasukan Lain
            </h4>
          </div>
        ...
        <div class="modal-body" id="dataFormPemasukanLain"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/formpemasukanlain.js"></script>
</body>
</html>