...
<html>
<head>
  <title> Pembelian Giro <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarPembelianGiro()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Pembelian Giro</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Pembelian Giro</h5>
                  </div>
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3">
                    <label>Bulan</label>
                    <select class="form-control select2" id="bulan" onchange="dataDaftarPembelianGiro()">
                      <?php  
                        $namaBulan = array("","Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember");
                        for($i=1; $i<13; $i++){
                          $selected=selected($i,$bulan);
                          if($i<10){
                            $bln="0".$i;
                          }
                          else{
                  ...
                  <div class="col-sm-3">
                    <label>Tahun</label>
                    <select class="form-control select2" id="tahun" onchange="dataDaftarPembelianGiro()">
                      <?php  
                  ...
                  <div class="col-sm-2" <?=$style?>>
                    <label>Tipe</label>
                    <select name="tipe" id="tipeSearch" class="form-control select2"  onchange="dataDaftarPembelianGiro()" >
                      <?php
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarPembelianGiro()">
                          Nama Supplier 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarPembelianGiro"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormPembelianGiro" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg" style="max-width : 70%">
      <div class="modal-content">
        ...
        <div class="modal-body" id="dataFormPembelianGiro"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/pembeliangiro.js"></script>
