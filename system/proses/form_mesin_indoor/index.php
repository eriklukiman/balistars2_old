...
<html>
<head>
  <title> Performa Mesin Indoor <?=$dataInformasi['nama']?></title>
  <meta charset="utf-8">
...
<body class="theme-blue" onload="dataDaftarMesinIndoor()">
          ...
          <div class="row">
            <div class="col-sm-12">                        
              ...
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Performa Mesin Indoor</li>
              </ul>
            </div>            
          ...
          <div class="col-sm-12">
            <div class="card planned_task">
              ...
              <div class="header">
                <div class="row">
                  <div class="col-sm-6">
                    <h5><i class="fa fa-list"></i> Daftar Performa Mesin Indoor</h5>
                  </div>
              ...
              <div class="body">
                ...
                <div class="row form-group">
                  <div class="col-sm-3" >
                    <label>Rentang</label>
                    <input type="datepicker" class="form-control" name="rentang" id="rentang" onchange="dataDaftarMesinIndoor()">
                  </div>
                </div>
                ...
                <div style="overflow-x: auto;">
                  <table class="table table-hover table-custom">
                    <thead class="bg-info text-white">
                      ...
                      <th>
                        <button class="btn btn-sm btn-info" onclick="dataDaftarMesinIndoor()">
                          Tanggal Order 
                        </button>
                      </th>
                      <th>
                    ...
                    <tbody id="dataDaftarMesinIndoor"></tbody>
                  </table>
                </div>
              </div>
              <!-- End Body -->
  ...
  <div id="modalFormMesinIndoor" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg" style="max-width : 70%">
      <div class="modal-content">
        <div class="modal-header alert alert-primary">
          <div class="col-sm-11">
            <h5 class="modal-title">
             Performa Mesin Indoor
           </h5>
          </div>
        ...
        <div class="modal-body" id="dataFormMesinIndoor"></div>
      </div>
    </div>
  </div>
  ...
  <script src="js/mesinindoor.js"></script>
