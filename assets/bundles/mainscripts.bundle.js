        ...
        $("#main-menu").metisMenu(),
            ...
            $(".btn-toggle-fullwidth").on("click", function () {
                $("body").hasClass("layout-fullwidth")
                    ? ($("body").removeClass("layout-fullwidth"), $(this).find(".fa").toggleClass("fa-arrow-left fa-arrow-right"))
                    : ($("body").addClass("layout-fullwidth"), $(this).find(".fa").toggleClass("fa-arrow-left fa-arrow-right"));
            }),
